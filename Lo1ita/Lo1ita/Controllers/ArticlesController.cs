...
namespace Lo1ita.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Details,UpdateData,CreatDate,Display,Author,CreaterGuid,Hits,Excerpt,Type")] Article article)
        {
            if (ModelState.IsValid)
            {
